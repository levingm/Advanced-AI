...
The Basel Committee on Banking Supervision \citep{bcbs2016irrbb} defines non-maturity deposits (NMDs) as liabilities without a contractual maturity where the depositor is free to withdraw at any time. They consist mainly of fully transferable deposits and deposits non-transferable deposits that can be converted
