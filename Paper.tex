...
All datapoints are based on January 2003 - December 2025:\\
- The overnight deposit volume and interest rate was sourced from Deutsche Bundesbank and consist of monthly end-of-period levels\citep{bundesbank_data}.\\
- The Euro Short-Term Rate $\text{€STR}$ sourced from the ECB, consisting of data for each business day\citep{ecb_estr}.\\
- The German geopolitical risk index $\mathrm{GPRC\_DEU}$ sourced monthly\citep{gpr_index}.\\
- The month-on-month inflation $\mathrm{MoM-Inflation}$ sourced monthly\citep{destatis_inflation}.\\
- The DAX index sourced with yfinance on business days\citep{dax_index}.\\
- The 10-year German bond yield $\mathrm{10Y~Bond}$ sourced on business days\citep{bundesbank_bonds}. \\
...
The target variable is the daily volume of overnight deposits $V_t$ held by private household, sourced from Deutsche Bundesbank.
% - Jump-problem 
% -------------------------------------------------------------------
